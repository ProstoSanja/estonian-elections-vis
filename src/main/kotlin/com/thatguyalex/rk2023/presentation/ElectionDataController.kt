...
import com.thatguyalex.rk2023.presentation.classes.elections.ElectionsDataDto
...
class ElectionDataController(
    ...
    fun getData(@PathVariable("electionType") electionType: ElectionType): ElectionsDataDto {
        return electionsResultsCachingApplication.getProcessedResults(electionType).let { ElectionsDataDto.from(it) }
    }
